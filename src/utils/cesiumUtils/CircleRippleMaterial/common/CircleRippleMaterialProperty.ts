...
const CircleRippleMaterialSource = CircleRippleMaterialGLSL.replace(/#define GLSLIFY 1/g, '')
...
class CircleRippleMaterialProperty {
  ...
  constructor(ob: { duration: number; gradient: number; color: Cesium.Color; count: number }) {
  ...
  getValue(time: any, result: any) {
    ...
    result.color = getValueOrClonedDefault(this._color, time, Cesium.Color.WHITE, result.color)
