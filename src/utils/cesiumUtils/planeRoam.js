...
import getPath from '@/utils/cesiumUtils/aircraftPath'
import DrawLines from '@/utils/cesiumUtils/drawLinesOld'
import ImportModel from '@/utils/cesiumUtils/importModelOld'
...
export const drawLinesAndAirplane = (viewer) => {
  ...
  setTimeout(() => {
    viewer.camera.flyTo({
      destination: Cesium.Cartesian3.fromDegrees(...viewPosition, 50000),
      orientation: {
        // heading
