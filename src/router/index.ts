  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: t('router.interferenceEdit'),
          noTagsView: true,
          noCache: true,
          hidden: true,
          canTo: true,
      ...
      {
        path: 'detail',
        component: () => import('@/views/Interference/Detail.vue'),
        name: 'InterferenceDetail',
        meta: {
          title: t('router.interferenceDetail'),
          noTagsView: true,
          noCache: true,
          hidden: true,
          canTo: true,
